...
class List extends React.Component {
    constructor(props) {
        ...
        this.handleDeleteSemester = this.handleDeleteSemester.bind(this);
    ...
    handleDeleteSemester() {
        Server
            .delete(`/api/semesters/${this.state.currentElement}`)
            .then(response => {
                this.getSemesterList();
                this.toggle();
            });
            ...
            },
            {
                ...
                Cell: row => (
                    <ButtonGroup style={{ display: 'block', textAlign: 'center'}}>
                        <Link className="btn btn-secondary" to={`/admin/semester/${row.row.id}/edit`} title="Edit">
        ...
        return (
            <React.Fragment>
                    ...
                    <CardHeader className="text-center">
                        <Row>
                            <Col md={8} className="text-right">
                                <h1 style={{ display: 'inline-block', textTransform: 'uppercase', letterSpacing: '5px' }}>Semester Management</h1>
                            </Col>
                            <Col md={4} className="text-right">
                                <Link to='/admin/semester/create'>
                ...
                <Modal isOpen={this.state.modal} toggle={this.toggle}>
                    ...
                    <ModalFooter>
                        <Button color="danger" onClick={this.handleDeleteSemester}>Delete</Button>{' '}
