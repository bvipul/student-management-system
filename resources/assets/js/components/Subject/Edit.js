...
const validatorSubjectEditForm = (values) => {
...
class Edit extends React.Component {
    ...
    componentDidMount() {
        Server
            .get(`/api/subjects/${this.props.match.params.id}`)
            .then((response) => {
    ...
    processSubmit(values) {
        Server
            .patch(`/api/subjects/${this.props.match.params.id}`, values)
            .then((response) => {
...
Edit = reduxForm({
  form: 'subjectEdit',
  validate: validatorSubjectEditForm
